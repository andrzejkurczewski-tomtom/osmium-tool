#ifndef EXTRACT_STRATEGY_COMPLETE_WAYS_BY_FIRST_NODE_AND_TAGS_HPP
#define EXTRACT_STRATEGY_COMPLETE_WAYS_BY_FIRST_NODE_AND_TAGS_HPP
...
#endif // EXTRACT_STRATEGY_COMPLETE_WAYS_BY_FIRST_NODE_AND_TAGS_HPP
